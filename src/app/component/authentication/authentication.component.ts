  ...
  login() {
    ...
    this.userService.login(userLogin).subscribe(
      (next: JwtDTO) => {
        ...
        //validamos sus autoridades en la pagina y determinamos opciones del navbar
        next.authorities.forEach(unaAuthority => {
          if (unaAuthority.authority.indexOf('ADMIN')) {
            this.commonService.setMenu(["REPORTES"]);
          }
